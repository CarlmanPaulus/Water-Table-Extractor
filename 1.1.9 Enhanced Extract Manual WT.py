...
import ctypes
ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID("hydrology.watertable.extractor.1.1.9")
...
_config_file = os.path.join(_prefs_dir, "config_119.json")
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Water Table Data Extractor  v1.1.9")
        try:
    ...
    def _build_ui(self):
        ...
        site_card = self._make_section("PIPE SELECTION  —  WT_Marudi", body_layout)
        site_inner = site_card.layout()
        site_inner.setSpacing(6)
        ...
        # Checkboxes grid — 5 columns for compact layout
        pipes = SITES_AND_PIPES["WT_Marudi"]
        grid = QGridLayout()
    ...
    def _initial_log(self):
        self._append_log("Water Table Data Extractor v1.1.9 ready.", "info")
...
if __name__ == "__main__":
    ...
    try:
        app.setWindowIcon(QIcon(resource_path("wticon.ico")))
    except Exception:
        pass
