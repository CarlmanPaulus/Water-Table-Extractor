...
_config_file = os.path.join(_prefs_dir, "config_117.json")
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Water Table Data Extractor  v1.1.7")
        try:
    ...
    def _build_ui(self):
        ...
        self.tabs.setMaximumHeight(275)
    ...
    def _initial_log(self):
        self._append_log("Water Table Data Extractor v1.1.7 ready.", "info")
